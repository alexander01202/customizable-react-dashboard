...
export const REACT_APP_BACKEND_URL = process.env.NODE_ENV === 'development' ? 'http://127.0.0.1:5000' : "https://admin.appnotis.com:3000"
...
export const MAIN_PAGE_MODAL_INPUT_OPTIONS = [
  ...
  {label: "CSV File", type: 'file', placeholder: "Upload CSV", value_reference: "csv_file"},
